...
*/
#ifdef OLC_PGEX_GROUND_OBJECT

#endif

namespace olc
{
	class GroundObject : public PGEX
	{

	public:
		GroundObject();
		GroundObject(std::string ImagePath, bool bIsSpriteSheet = false);
	...
	public:
		...
		*/
		...
		struct ObjectProperites
		{
			...
			int8_t nObjectNumber = 0;	        // Object Number, Default 0 i.e. Backupground 1 , GroundObject 2 etc
...
#ifdef OLC_PGEX_GROUND_OBJECT
#undef OLC_PGEX_GROUND_OBJECT

namespace olc
{

	// See Step 3: Rename to your Class name
	GroundObject::GroundObject() : PGEX(true)
	{
		bisSpriteSheet = false;
	}

	GroundObject::GroundObject(std::string ImagePath, bool bIsSpriteSheet) : PGEX(true)
	{
	...
	// See Step 3: Rename to your Class name
	void GroundObject::OnBeforeUserCreate()
	{
		// Fires just before the main OnUserCreate
	...
	// See Step 3: Rename to your Class name
	void GroundObject::OnAfterUserCreate()
	{
		// Fires just After the main OnUserCreate
	}

	// See Step 3: Rename to your Class name
	bool GroundObject::OnBeforeUserUpdate(float& fElapsedTime)
	{
		// Fires just before the main OnUserUpdate
	...
	// See Step 3: Rename to your Class name
	void GroundObject::OnAfterUserUpdate(float fElapsedTime)
	{
		// Fires just After the main OnUserUpdate
	}

	// See Step 3: Rename to your Class name
	void GroundObject::DrawDecal()
	{
